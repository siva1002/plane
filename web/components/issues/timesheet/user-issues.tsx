            ...
            <div className="group relative flex border-b border-custom-border-200">
                <table className="divide-x-[0.5px] divide-custom-border-200 overflow-y-auto">
                    <thead className="sticky top-0 left-0 z-[1] border-b-[0.5px] border-custom-border-100">
                        <th className="sticky left-0 z-[1] h-11 w-[26rem] flex items-center bg-custom-background-90 text-sm font-medium before:absolute before:h-full before:right-0 before:border-[0.5px]  before:border-custom-border-100">
